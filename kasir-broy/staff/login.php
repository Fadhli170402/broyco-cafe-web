        ...
        <div class="col-md-4 p-3 p-md-5">
            <div class="container">
                <div class="card card-login mx-auto mt-5 text-center">
                    <div class="card-header text-center text-white bg-dark">Login Area</div>
                    <div class="card-body text-center">
                        <form id="loginform">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" class="btn btn-dark col-12" form="loginform" name="btnlogin" value="L O G I N" />
                            </div>
                        </form>
                        <br/>
...
<script type="text/javascript">$('#loginform').submit(function(){$.ajax({type:"POST",url:'process.php',data:{username:$("#inputUsername").val(),password:$("#inputPassword").val()},success:function(data) {if(data==='correct'){window.location.replace('index.php');} else{$("#warningbox").html("<div class='alert alert-danger' role='alert'>"+data+"!</div>");}}});return false;});</script>
</body>
